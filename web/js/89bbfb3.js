...
t.add("decks.defaultemptydesc", "*Not enough Captain Cards.*", "messages", "en");
...
t.add("decks.problems.undefined", "Contains too few Cards", "messages", "en");
...
t.add("decks.smartfilter.example", "Example: <tt>o:1 n>1<\/tt> shows all of the cards with a cost of 1 and an expense value > 1", "messages", "en");
...
t.add("decks.smartfilter.filters.faction_code", "Ship", "messages", "en");
t.add("decks.smartfilter.filters.complication_name", "Complication Name", "messages", "en");
...
t.add("decks.smartfilter.filters.expense_value", "Expense Value", "messages", "en");
...
t.add("search.contracttexts", "Contracts and Complications", "messages", "en");
...
t.add("search.faction", "Ships and Ship Specific Cards", "messages", "en");
...
t.add("card.erratas.title", "Errata & Clarifications", "messages", "en");
t.add("card.erratas.none", "No errata yet needed for this card.", "messages", "en");
t.add("card.erratas.unreleased", "Erratas will be enabled for this card when it is officially released.", "messages", "en");
t.add("card.erratas.like", "Like that errata", "messages", "en");
t.add("card.erratas.edit", "Edit errata", "messages", "en");
t.add("card.erratas.write", "New Errata", "messages", "en");
t.add("card.erratas.hint", "Write your analysis of the card, in at least %min% characters. You can write a number of card reviews equal to your reputation. This is not a place for questions or comments. Type # to enter a card name. Type $ to enter a symbol.", "messages", "en");
t.add("card.erratas.submit", "Submit preview", "messages", "en");
t.add("card.erratas.posted", "Your errata has been posted. It will appear on the site in a few minutes.", "messages", "en");
t.add("card.erratas.comments.add", "Add a comment", "messages", "en");
t.add("card.erratas.comments.hint", "Your comment", "messages", "en");
t.add("card.erratas.comments.post", "Post", "messages", "en");
t.add("card.erratas.comments.posted", "Your comment has been posted. It will appear on the site in a few minutes.", "messages", "en");
t.add("card.erratas.alerts.minimum", "Your review must at least %min% characters long.", "messages", "en");
...
t.add("card.info.skill", "Crew Skill", "messages", "en");
...
t.add("card.info.complicationname", "Complication Name", "messages", "en");
t.add("card.info.complicationtext", "Complication Requirements", "messages", "en");
t.add("card.info.contractname", "Contract Name", "messages", "en");
t.add("card.info.contractrequirements", "Contract Requirements", "messages", "en");
t.add("card.info.subplots", "Contract Subplots", "messages", "en");
t.add("card.info.victorypoints", "Contract Victory Points", "messages", "en");
t.add("card.info.abandonment", "Contract Abandonment Cost", "messages", "en");
t.add("card.info.abandmod", "Complication Abandonment Modifier", "messages", "en");
t.add("card.info.distance", "Contract Jump Distance", "messages", "en");
t.add("card.info.compslots", "Complication Slots", "messages", "en");
...
t.add("decks.smartfilter.filters.complication_name", "Complication Name", "messages", "es");
...
t.add("decks.smartfilter.filters.expense_value", "Expense Value", "messages", "es");
...
t.add("decks.charts.vps.title", "Contract Victory Points", "messages", "es");
t.add("decks.charts.vps.subtitle", "Adventure Deck only", "messages", "es");
t.add("decks.charts.vps.tooltip.header", "Victory Points %vps%", "messages", "es");
t.add("decks.charts.vps.tooltip.label", "# cartes", "messages", "es");
...
t.add("card.erratas.title", "Errata y Aclaraciones", "messages", "es");
t.add("card.erratas.none", "A\u00fan no se necesita errata para esta tarjeta.", "messages", "es");
t.add("card.erratas.unreleased", "Las erratas se habilitar\u00e1n para esta tarjeta cuando se lance oficialmente.", "messages", "es");
t.add("card.erratas.like", "Como la errata", "messages", "es");
t.add("card.erratas.edit", "Editar errata", "messages", "es");
t.add("card.erratas.write", "Nueva errata", "messages", "es");
t.add("card.erratas.hint", "Escribe tu an\u00e1lisis de esta carta en al menos %min% caracteres. Puedes escribir tantas rese\u00f1as como tu reputaci\u00f3n. \u00c9ste no es lugar para preguntas o comentarios. Escribe # para introducir el nombre de una carta. Escribe $ para introducir un s\u00edmbolo.", "messages", "es");
t.add("card.erratas.submit", "Enviar rese\u00f1a", "messages", "es");
t.add("card.erratas.posted", "Tu errata ha sido publicada. Aparecer\u00e1 en el sitio en unos minutos.", "messages", "es");
t.add("card.erratas.comments.add", "A\u00f1adir un comentario", "messages", "es");
t.add("card.erratas.comments.hint", "Tu comentario", "messages", "es");
t.add("card.erratas.comments.post", "Enviar", "messages", "es");
t.add("card.erratas.comments.posted", "Tu comentario se ha enviado. Aparecer\u00e1 en unos pocos minutos.", "messages", "es");
t.add("card.erratas.alerts.minimum", "Tu rese\u00f1a debe tener al menos %min% caracteres.", "messages", "es");
...
t.add("card.info.skill", "Skillo", "messages", "es");
...
t.add("card.info.wound", "Wounds", "messages", "es");
t.add("card.info.species", "Species", "messages", "es");
t.add("card.info.requiredskill", "Required Skill", "messages", "es");
t.add("card.info.tonnage", "Tonnage", "messages", "es");
t.add("card.info.structure", "Structure", "messages", "es");
t.add("card.info.capabilites", "Capabilities", "messages", "es");
