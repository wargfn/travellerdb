...
class CardsData
{
    ...
    public function replaceSymbols ($text)
    {
        static $displayTextReplacements = [
            ...
            '[Ship]' => '<span class="icon-ship"></span>',
            '[Initiative]' => '<span class="icon-initiative"></span>',
            '[connection]' => '<span class="icon-connection"></span>',
            '[Connection]' => '<span class="icon-connection"></span>',
            '[Cargo]' => '<span class="icon-cargo"></span>',
            '[Cargo/Passenger]' => '<span class="icon-cargopassenger"></span>',
            '[Passenger]' => '<span class="icon-passenger"></span>',
            '[Military]' => '<span class="icon-military"></span>',
            '[Survey]' => '<span class="icon-survey"></span>',
            '[Military/Survey]' => '<span class="icon-militarysurvey"></span>',
            '[Subplot]' => '<span class="icon-subplot"></span>',
            '[Reaction]' => '<span class="icon-react"></span>',
            '[Exert]' => '<span class="icon-exert"></span>',
            '[Event]' => '<span class="icon-event"></span>',
            '[0]' => '<span class="icon-0"></span>',
            '[1]' => '<span class="icon-1"></span>',
            '[2]' => '<span class="icon-2"></span>',
            '[3]' => '<span class="icon-3"></span>',
            '[4]' => '<span class="icon-4"></span>',
            '[5]' => '<span class="icon-5"></span>',
            '[6]' => '<span class="icon-6"></span>',
            '[Upgrade]' => '<span class="icon-upgrade"></span>',
            '[Ready]' => '<span class="icon-ready"></span>',
            '[Use]' => '<span class="icon-use"></span>',
            '\n' => '<br>',
            '[VictoryPoint]' => '<span class="icon-victorypoint"></span>',
            '[Wound]' => '<span class="icon-wound"></span>',
            '[Expense]' => '<span class="icon-expense"></span>',
            '[Contract]' => '<span class="icon-contract"></span>',
            '[Complications]' => '<span class="icon-complication"></span>',
            '[Complication]' => '<span class="icon-complication"></span>',
            '[Compslot]' => '<span class="icon-complication"></span>',
            '[Infamy]' => '<span class="icon-infamy"></span>',
            '[ContractAdandonment]' => '<span class="icon-contrataband"></span>',
            '[AbandPenModifer]' => '<span class="icon-contractaband"></span>',
            '[AbandPenalty]' => '<span class="icon-contractaband"></span>',
            '[Gear]' => '<span class="icon-gear"></span>',
            '[Crew]' => '<span class="icon-crew"></span>',
            '[Action]' => '<span class="icon-action"></span>',
            '[Structure]' => '<span class="icon-structure"></span>',
            '[Admin]' => '<span class="icon-admin"></span>',
            '[Trained:Admin]' => '<span class="icon-trainedadmin"></span>',
            '[Expert:Admin]' => '<span class="icon-expertadmin"></span>',
            '[Combat]' => '<span class="icon-combat"></span>',
            '[Trained:Combat]' => '<span class="icon-trainedcombat"></span>',
            '[Expert:Combat]' => '<span class="icon-expertcombat"></span>',
            '[Jack]' => '<span class="icon-jack"></span>',
            '[Trained:Jack]' => '<span class="icon-trainedjack"></span>',
            '[Expert:Jack]' => '<span class="icon-expertjack"></span>',
            '[Medical]' => '<span class="icon-medical"></span>',
            '[Trained:Medical]' => '<span class="icon-trainedmedical"></span>',
            '[Expert:Medical]' => '<span class="icon-expertmedical"></span>',
            '[Psionics]' => '<span class="icon-psionic"></span>',
            '[Trained:Psionics]' => '<span class="icon-trainedpsionic"></span>',
            '[Expert:Psionics]' => '<span class="icon-expertpsionic"></span>',
            '[Psionic]' => '<span class="icon-psionic"></span>',
            '[Trained:Psionic]' => '<span class="icon-trainedpsionic"></span>',
            '[Expert:Psionic]' => '<span class="icon-expertpsionic"></span>',
            '[Science]' => '<span class="icon-science"></span>',
            '[Trained:Science]' => '<span class="icon-trainedscience"></span>',
            '[Expert:Science]' => '<span class="icon-expertscience"></span>',
            '[Social]' => '<span class="icon-social"></span>',
            '[Trained:Social]' => '<span class="icon-trainedsocial"></span>',
            '[Expert:Social]' => '<span class="icon-expertsocial"></span>',
            '[StarshipOps]' => '<span class="icon-starshipoperation"></span>',
            '[Trained:StarshipOps]' => '<span class="icon-trainedstarshipoperation"></span>',
            '[Expert:StarshipOps]' => '<span class="icon-expertstarshipoperation"></span>',
            '[StarshipOperations]' => '<span class="icon-starshipoperation"></span>',
            '[Trained:StarshipOperations]' => '<span class="icon-trainedstarshipoperation"></span>',
            '[Expert:StarshipOperations]' => '<span class="icon-expertstarshipoperation"></span>',
            '[StarshipOperation]' => '<span class="icon-starshipoperation"></span>',
            '[Trained:StarshipOperation]' => '<span class="icon-trainedstarshipoperation"></span>',
            '[Expert:StarshipOperation]' => '<span class="icon-expertstarshipoperation"></span>',
            '[Tech]' => '<span class="icon-tech"></span>',
            '[Trained:Tech]' => '<span class="icon-trainedtech"></span>',
            '[Expert:Tech]' => '<span class="icon-experttech"></span>',
            '[Underworld]' => '<span class="icon-underworld"></span>',
            '[Trained:Underworld]' => '<span class="icon-trainedunderworld"></span>',
            '[Expert:Underworld]' => '<span class="icon-expertunderworld"></span>',
            '[Attack]' => '<span class="icon-attack"></span>',
            '[Defense]' => '<span class="icon-defense"></span>',
            '[Limit]' => '<span class="icon-limit"></span>',
            '[Limited]' => '<span class="icon-limited"></span>',
            '[Heroic]' => '<span class="icon-heroic"></span>',
            '[Internal]' => '<span class="icon-internal"></span>',
            '[Distance]' => '<span class="icon-distance"></span>',
            '[Gene]' => '<span class="icon-gene"></span>',
            '[Organization]' => '<span class="icon-organization"></span>',
            '[Computer]' => '<span class="icon-computer"></span>',
